...
%% Violin plot data
writematrix([T2DM.BMI, T2DM.BW, noT2DM.BMI, noT2DM.BW, noT2DM.gender], "BMI_BW_data.csv");
...
% end
%% expected change FFM and FM over 1 year
p = Model.pkParameters();
dose = ones(1, 52);
num_patients = T2DM.num_patients;
T2DM_FFM = T2DM.FFM;
T2DM_FM = T2DM.FM;
changeFFM25 = zeros(num_patients, 1);
changeFM25 = zeros(num_patients, 1);
changeFFM50 = zeros(num_patients, 1);
changeFM50 = zeros(num_patients, 1);
changeFFM75 = zeros(num_patients, 1);
changeFM75 = zeros(num_patients, 1);
changeFFM100 = zeros(num_patients, 1);
changeFM100 = zeros(num_patients, 1);
...
parfor i = 1:num_patients
    ...
    y0(5:6) = [FFM, FM];
    [~, y] = Model.simulatePD(p, y0, dose25);
    changeFFM25(i) = (y(end, 5)/FFM) - 1;
    changeFM25(i) = (y(end, 6)/FM) - 1;
end
...
parfor i = 1:num_patients
    ...
    y0(5:6) = [FFM, FM];
    [~, y] = Model.simulatePD(p, y0, dose50);
    changeFFM50(i) = (y(end, 5)/FFM) - 1;
    changeFM50(i) = (y(end, 6)/FM) - 1;
end
...
parfor i = 1:num_patients
    ...
    y0(5:6) = [FFM, FM];
    [~, y] = Model.simulatePD(p, y0, dose75);
    changeFFM75(i) = (y(end, 5)/FFM) - 1;
    changeFM75(i) = (y(end, 6)/FM) - 1;
end
...
parfor i = 1:num_patients
    ...
    y0(5:6) = [FFM, FM];
    [~, y] = Model.simulatePD(p, y0, dose100);
    changeFFM100(i) = (y(end, 5)/FFM) - 1;
    changeFM100(i) = (y(end, 6)/FM) - 1;
end
...
noT2DM_FFM = noT2DM.FFM;
noT2DM_FM = noT2DM.FM;
noT2DM_changeFFM25 = zeros(num_patients, 1);
noT2DM_changeFM25 = zeros(num_patients, 1);
noT2DM_changeFFM50 = zeros(num_patients, 1);
noT2DM_changeFM50 = zeros(num_patients, 1);
noT2DM_changeFFM75 = zeros(num_patients, 1);
noT2DM_changeFM75 = zeros(num_patients, 1);
noT2DM_changeFFM100 = zeros(num_patients, 1);
noT2DM_changeFM100 = zeros(num_patients, 1);
...
parfor i = 1:num_patients
    ...
    y0(5:6) = [FFM, FM];
    [~, y] = Model.simulatePD(p, y0, dose25);
    noT2DM_changeFFM25(i) = (y(end, 5)/FFM) - 1;
    noT2DM_changeFM25(i) = (y(end, 6)/FM) - 1;
end
...
parfor i = 1:num_patients
    ...
    y0(5:6) = [FFM, FM];
    [~, y] = Model.simulatePD(p, y0, dose50);
    noT2DM_changeFFM50(i) = (y(end, 5)/FFM) - 1;
    noT2DM_changeFM50(i) = (y(end, 6)/FM) - 1;
end
...
parfor i = 1:num_patients
    ...
    y0(5:6) = [FFM, FM];
    [~, y] = Model.simulatePD(p, y0, dose75);
    noT2DM_changeFFM75(i) = (y(end, 5)/FFM) - 1;
    noT2DM_changeFM75(i) = (y(end, 6)/FM) - 1;
end
...
parfor i = 1:num_patients
    ...
    y0(5:6) = [FFM, FM];
    [~, y] = Model.simulatePD(p, y0, dose100);
    noT2DM_changeFFM100(i) = (y(end, 5)/FFM) - 1;
    noT2DM_changeFM100(i) = (y(end, 6)/FM) - 1;
end

writematrix([ ... % 2.5, 5.0, 7.5, 10.0, Fat-mass?, T2DM?
    changeFFM25, changeFFM50, changeFFM75, changeFFM100, ones(num_patients, 1), ones(num_patients, 1); ...
    noT2DM_changeFFM25, noT2DM_changeFFM50, noT2DM_changeFFM75, noT2DM_changeFFM100, ones(num_patients, 1), zeros(num_patients, 1); ...
    changeFM25, changeFM50, changeFM75, changeFM100, zeros(num_patients, 1), ones(num_patients, 1); ...
    noT2DM_changeFM25, noT2DM_changeFM50, noT2DM_changeFM75, noT2DM_changeFM100, zeros(num_patients, 1), zeros(num_patients, 1)], ...
    'changeFFM_FM.csv' ...
    );
